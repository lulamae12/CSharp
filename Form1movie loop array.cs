...
namespace movie
{
    ...
    {
        public int age;
        string[] movies = { "Back to the future", "Logan", "The Lion King", "Wonder Woman", "Interstellar" };
        ...
        public Form1()
        {
            ...
            list.Items.Add(movies[0]);
            list.Items.Add(movies[1]);
            list.Items.Add(movies[2]);
            list.Items.Add(movies[3]);
            list.Items.Add(movies[4]);
        }
